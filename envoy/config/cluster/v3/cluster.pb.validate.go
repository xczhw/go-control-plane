...
func (m *Cluster) validate(all bool) error {
	...
	case *Cluster_CustomizedLbConfig_:
		if v == nil {
			err := ClusterValidationError{
				field:  "LbConfig",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetCustomizedLbConfig()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ClusterValidationError{
						field:  "CustomizedLbConfig",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetCustomizedLbConfig()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return ClusterValidationError{
					field:  "CustomizedLbConfig",
					reason: "embedded message failed validation",
...
// Validate checks the field values on Cluster_CustomizedLbConfig with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *Cluster_CustomizedLbConfig) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Cluster_CustomizedLbConfig with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// Cluster_CustomizedLbConfigMultiError, or nil if none found.
func (m *Cluster_CustomizedLbConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *Cluster_CustomizedLbConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if wrapper := m.GetChoiceCount(); wrapper != nil {
		...
		if wrapper.GetValue() < 2 {
			err := Cluster_CustomizedLbConfigValidationError{
				field:  "ChoiceCount",
				reason: "value must be greater than or equal to 2",
			}
			if !all {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, Cluster_CustomizedLbConfigValidationError{
					field:  "ActiveRequestBias",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return Cluster_CustomizedLbConfigValidationError{
				field:  "ActiveRequestBias",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return Cluster_CustomizedLbConfigMultiError(errors)
	}

	return nil
}

// Cluster_CustomizedLbConfigMultiError is an error wrapping multiple
// validation errors returned by Cluster_CustomizedLbConfig.ValidateAll() if
// the designated constraints aren't met.
type Cluster_CustomizedLbConfigMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Cluster_CustomizedLbConfigMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Cluster_CustomizedLbConfigMultiError) AllErrors() []error { return m }

// Cluster_CustomizedLbConfigValidationError is the validation error returned
// by Cluster_CustomizedLbConfig.Validate if the designated constraints aren't met.
type Cluster_CustomizedLbConfigValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Cluster_CustomizedLbConfigValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Cluster_CustomizedLbConfigValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Cluster_CustomizedLbConfigValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Cluster_CustomizedLbConfigValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Cluster_CustomizedLbConfigValidationError) ErrorName() string {
	return "Cluster_CustomizedLbConfigValidationError"
}

// Error satisfies the builtin error interface
func (e Cluster_CustomizedLbConfigValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCluster_CustomizedLbConfig.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Cluster_CustomizedLbConfigValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = Cluster_CustomizedLbConfigValidationError{}
